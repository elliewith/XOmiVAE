...
class PyTorchDeepExplainer(Explainer):
    ...
    def __init__(self, model, data,outputNumber,dim ,explainLatentSpace):
        ...
        with torch.no_grad():
            ...
            #This is where specifiy whether we want to explain the mean or z output
            ...
            if explainLatentSpace:
                ...
                self.dimension=dim
                output = output[:, dim]
                output = output.resize(output.shape[0], 1)
    ...
    def gradient(self, idx, inputs):
        ...
        if self.explainLatent==True:
            ...
            outputs = outputs.resize(outputs.shape[0], 1)
    ...
    def shap_values(self, X, ranked_outputs=None, output_rank_order="max", check_additivity=False):
        ...
        if ranked_outputs is not None and self.multi_output:
            with torch.no_grad():
                ...
                #My change (EW) to adjust for the additional outputs in VAE model
